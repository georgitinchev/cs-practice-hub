...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if temperature >= 800:
        print("Temperature is more than 800 Kelvin")
        return False
    elif neutrons_emitted <= 500:
        print("Neutrons emitted per seond are less than 500")
        return False
    elif (temperature * neutrons_emitted) >= 500000:
        print("Product is higher than 500 000")
        return False
    else:
        print("Reactor is balanced")
        return True
