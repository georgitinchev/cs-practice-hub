...
export function remainingMinutesInOven(actualMinutesInOven) {
  var remaining = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
  return remaining;
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  var prepTime = numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
  return prepTime;
}
/**
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  var layers = preparationTimeInMinutes(numberOfLayers);
